	...
	return {
		...
		methods: {
			onMyButtonClick: function() {
				...
				this.showInformationDialog("PUSH ME button works good.");
				this.set("UsrArea", 3000); // demo
			},
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName332108d1-4e80-4c9d-b9ca-fa66a1e215a5",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT25bd3e38-505a-4d78-845e-22c81b525749",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT17eb03ce-f74a-48ce-a942-ca9c3a31429e",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPeabd4368-9d54-4cd3-8d66-8545db8760ce",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPd8c7c0e8-067d-4793-8c8b-4b50e7c5596e",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRINGea5e7030-3eec-4f8d-bacd-758d87ade694",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 2,
